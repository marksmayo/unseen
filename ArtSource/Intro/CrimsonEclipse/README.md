...
A moving lunar shadow, red sun, orbiting sculpted ink ribbons, sequential letter reveal and vermilion seal.
...
- CrimsonEclipse.mp4 — full animation
- CrimsonEclipse.blend — editable geometry, lighting, camera and keyframes
- preview.png — title frame (frame 132)

Regenerate from the repository root:

~~~powershell
& 'C:/Program Files/Blender Foundation/Blender 5.2/blender.exe' -b --python Tools/build_intro_alternatives.py -- --variant eclipse
~~~
